...
app.post('/register', async (req, res) =>
{
    try {
        ...
        //create a new user (id is undefined because it will be generated by the storage)
        const newUser = new User(undefined, email, phone, fullName, [new UserProfile(undefined, first_name )], password);
 ...
 * @returns {Object} {success: boolean, message?: string, data?: { user: UserInfo }}
 */
app.post('/get-user-info', async (req, res) =>
{
    try
    {
        ...
        return res.json({ success: true, data: { user: userRes.data.toPublicJSON() } });
    }
    catch (error)
    {
        return res.json({ success: false, message: error.message });
 ...
 * @returns {Object} {success: boolean, message?: string, data?: { profiles: Array<UserProfile> }}
 */
app.post('/save-profiles', async (req, res) => 
{
    try 
    {
        ...
        return res.json({ success: true, data: { profiles: serializedProfiles } });
    } 
    catch (error) 
    {
        return res.json({ success: false, message: error.message });
 ...
 * @returns {Object} {success: boolean, message?: string, data?: { media: MediaItem }}
 */
app.post('/get-media-by-id', async (req, res) =>
{
    try
    {
        ...
        return res.json({ success: true, data: { media: mediaRes.data.toJSON() } });
    }
    catch (error)
    {
        return res.json({ success: false, message: error.message });
 ...
 * @returns {Object} {success: boolean, data: { media: Array<MediaItem> }}
 */
app.post('/get-all-media-items', async (req, res) => {
    try 
    {
        ...
        if (!mediaRes.success) return res.json({ success: false, message: mediaRes.message });
        const serializedMedia = (mediaRes.data || []).map(m => m.toJSON());
        return res.json({ success: true, data: { media: serializedMedia } });
    }
    catch (error)
    {
        return res.json({ success: false, message: error.message });
 ...
 * @param {string|number} req.body.mediaID
 * @returns {Object} {success: boolean, message?: string, data?: { profile: UserProfile, media: MediaItem }}
 */
app.post('/toggle-media-like', async (req, res) =>
{
    try
    {
        ...
        //return the data as: { profile: profile.clone(), media: media.clone() }
        if (!likeRes.success) return res.json({ success: false, message: likeRes.message });

        return res.json({ success: true, message: likeRes.message, data: { profile: likeRes.data.profile.toJSON(), media: likeRes.data.media.toJSON() } });
    }
    catch (error)
    {
        return res.json({ success: false, message: error.message });
 ...
 * @param {string|number} req.body.profileID
 * @param {string|number} req.body.mediaID
 * @returns {Object} {success: boolean, message?: string, data?: { profile: UserProfile }}
 */
app.post('/select-media-item', async (req, res) =>
{
    try
    {
        ...
        //return the data as: { profile: profile.clone() }
        if (!watchRes.success) return res.json({ success: false, message: watchRes.message });

        return res.json({ success: true, data: { profile: watchRes.data.profile.toJSON() } });
    }
    catch (error)
    {
        return res.json({ success: false, message: error.message });
